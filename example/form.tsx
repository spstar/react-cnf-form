...
export default function ExampleForm() {
    ...
    return (
        <div className="example-form">
            ...
            <p>
                详细使用文档请参考 <a href="https://ant-design.gitee.io/components/form-cn/" target="_blank">antd From</a> 的文档使用
            </p>
            <ul>
                <li>
                    CnfForm 组件支持所有<a href="https://ant-design.gitee.io/components/form-cn/#Form" target="_blank">antd
                    Form</a> 的配置
                </li>
                <li>
                ...
                <li>
                    所有antd 内置的组件配置项都放到itemProps对象下面，对应的组件配置项参考对应的配置即可；
                </li>
                <li>
                    核心原则不影响antd 组件的任何功能使用，只是同过配置项的方式让form表单页面实现更简单；
            ...
            <span>下面的表单样式有些丑陋，其主要是用来展示 react-cnf-form 如何配置使用</span>
            <hr/>
            ...
            <div className="mt-10" style={{paddingBottom: 100}}>
                <Input.TextArea autoSize={{minRows: 10}} value={fieldsStr} className="Textarea"/>
            </div>
        </div>
    );
};
